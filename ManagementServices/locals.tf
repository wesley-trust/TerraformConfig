...
locals {
  ...
  resource_prod_traffic_manager_location         = lookup(var.service_traffic_manager_location, "Prod", null)
  ...
  resource_prod_dr_traffic_manager_location         = lookup(var.service_traffic_manager_location, "Prod-DR", null)
