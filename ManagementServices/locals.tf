...
locals {
  ...
  resource_traffic_manager_location         = lookup(var.service_traffic_manager_location, "${terraform.workspace}", null)
  ...
  resource_bcdr_traffic_manager_location         = lookup(var.service_traffic_manager_location, "BCDR", null)
