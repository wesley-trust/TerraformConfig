...
locals {
  ...
  resource_prod_network_hub_peering              = lookup(var.resource_network_hub_peering, "Prod", null)
  ...
  resource_prod_dr_network_hub_peering              = lookup(var.resource_network_hub_peering, "Prod-DR", null)
}
