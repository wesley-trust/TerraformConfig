...
locals {
  ...
  resource_storage_sync_locations           = lookup(var.service_storage_sync_location, "${terraform.workspace}", null)
  ...
  resource_bcdr_storage_sync_locations           = lookup(var.service_storage_sync_location, "BCDR", null)
}
