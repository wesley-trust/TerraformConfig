...
locals {
  ...
  resource_prod_storage_sync_locations           = lookup(var.service_storage_sync_location, "Prod", null)
  ...
  resource_prod_dr_storage_sync_locations           = lookup(var.service_storage_sync_location, "Prod-DR", null)
}
